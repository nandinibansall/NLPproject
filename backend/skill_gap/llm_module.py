...
#     missing_required = skill_gap_data["missing_required_skills"]
#     missing_preferred = skill_gap_data["missing_preferred_skills"]

#     prompt = f"""
#     The user wants to become a {skill_gap_data['role']}.
